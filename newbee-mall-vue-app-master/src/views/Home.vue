    ...
    <div class="good">
      ...
      <div class="good-box">
        <div class="good-item" v-for="item in newGoodses" :key="item.goodsId" @click="goToDetail(item)">
          <img :src="prefix(item.cover_img)" alt="">
          <div class="good-desc">
...
export default {
  ...
  mounted() {
    ...
    // const { data } =getHome()
        // 获取轮播图的数据
    getHome("/goods/carousels/").then(res=>{
      console.log('轮播图',res)
      this.swiperList = res;
    }).catch(error=>{
      console.log(error)
      ...
      console.log(error)
        ...
        // 获取热门商品
      getHome("/goods/hotgoods/").then(res=>{
      ...
      console.log(error)
        ...
        // 获取新品
      getHome("/goods/newgoods/").then(res=>{
      console.log('新品',res)
       this.newGoodses = res
    }).catch(error=>{
      console.log(error)
        ...
        // 最新推荐
      getHome("/goods/recomgoods/").then(res=>{
      console.log('最新推荐',res)
       this.recommends = res
    }).catch(error=>{
      console.log(error)
    })
